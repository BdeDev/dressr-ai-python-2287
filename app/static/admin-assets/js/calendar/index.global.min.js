...
var FullCalendar = function (e) {
    ...
    function _e(e, t = e, n = t.firstChild) {
        if (!Re.has(e)) {
            ...
            t.insertBefore(i, n), t.insertBefore(r, i), Re.set(e, i),
                function (e) {
    ...
    let ke;
    "undefined" != typeof document && _e(document, document.head, document.head.querySelector("script,link,style"));
    ...
    function Wo(e) {
        ...
        var r;
        return t.content && (r = t, n = e => p(qr.Consumer, null, t => p(as, {
            elTag: "div",
            elClasses: Ao(t.viewSpec),
    ...
    function Go(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Zo(e, t.sourceIds ? wt(t.sourceIds) : $o(e, r), i, t.isRefetch || !1, r);
            case "RECEIVE_EVENTS":
    ...
    function Yo(e, t, n) {
        return Zo(e, At(e, e => function (e, t, n) {
    ...
    class ua {
        constructor(e) {
            ...
            ba(c, a) && this.emitter.trigger("loading", !0), this.state = c, this.updateData(), this.actionRunner.resume()
        }
        resetOptions(e, t) {
            let {
                props: n
    ...
    class xa extends Zr {
        constructor() {
            super(...arguments), this.buildViewContext = nn(Yr), this.buildViewPropTransformers = nn(Ta), this.buildToolbarProps = nn(_a), this.headerRef = {
                current: null
            }, this.footerRef = {
                current: null
    ...
    class Na {
        constructor(e) {
            this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = e => {
                ...
                if (this.isDragging) {
                    let t = e.target;
                    t.removeEventListener("touchmove", this.handleTouchMove), t.removeEventListener("touchend", this.handleTouchEnd), t.removeEventListener("touchcancel", this.handleTouchEnd), window.removeEventListener("scroll", this.handleTouchScroll, !0), this.emitter.trigger("pointerup", this.createEventFromTouch(e)), this.cleanup(), this.isTouchDragging = !1, Ma += 1, setTimeout(() => {
                        Ma -= 1
                ...
                passive: !0
            }), Ia += 1, 1 === Ia && window.addEventListener("touchmove", Pa, {
                passive: !1
            })
        }
        destroy() {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {
                passive: !0
            }), Ia -= 1, Ia || window.removeEventListener("touchmove", Pa, {
                passive: !1
            })
        }
        tryStart(e) {
    ...
    class Wa {
        ...
        handleMove(e, t) {
            if (this.isEnabled) {
                ...
                i < 0 ? this.everMovedUp = !0 : i > 0 && (this.everMovedDown = !0), s < 0 ? this.everMovedLeft = !0 : s > 0 && (this.everMovedRight = !0), this.pointerScreenX = n, this.pointerScreenY = r, this.isAnimating || (this.isAnimating = !0, this.requestAnimation(Ua()))
            }
        }
        stop() {
            if (this.isEnabled) {
    ...
    class La extends Yi {
        constructor(e, t) {
            ...
            n.emitter.on("pointerdown", this.onPointerDown), n.emitter.on("pointermove", this.onPointerMove), n.emitter.on("pointerup", this.onPointerUp), t && (n.selector = t), this.mirror = new Ha, this.autoScroller = new Wa
        }
        destroy() {
    ...
    class Fa {
        constructor(e) {
            this.origRect = Or(e), this.scrollCaches = Nr(e).map(e => new ja(e, !0))
        }
        destroy() {
            for (let e of this.scrollCaches) e.destroy()
        }
        ...
        isWithinClipping(e, t) {
            ...
            for (let e of this.scrollCaches)
                if (!Va(e.getEventTarget()) && !ir(n, e.clientRect)) return !1;
            return !0
        }
    }
    ...
    class Ga {
        ...
        prepareHits() {
            this.offsetTrackers = Dt(this.droppableStore, e => (e.component.prepareHits(), new Fa(e.el)))
        }
        releaseHits() {
            let {
                offsetTrackers: e
    ...
    class Ya extends Gi {
        constructor(e) {
            ...
            let {
                ...
                options: n
            } = t.context, r = this.dragging = new La(e.el);
            r.pointer.selector = Ya.SELECTOR, r.touchScrollAllowed = !1, r.autoScroller.isEnabled = n.dragScroll;
            let i = this.hitDragging = new Ga(this.dragging, qi);
    ...
    class $a {
        constructor(e, t) {
            ...
            let n = this.hitDragging = new Ga(e, qi);
    ...
    var Ka = Po({
        ...
        componentInteractions: [class extends Gi {
            constructor(e) {
                super(e), this.handlePointerDown = e => {
                    ...
                    if (!n.wasTouchScroll) {
                        ...
                        if (n && r && Qa(n, r)) {
                            let {
                                context: r
                            } = t, i = Object.assign(Object.assign({}, qa(n.dateSpan, r)), {
                                dayEl: n.dayEl,
                                jsEvent: e.origEvent,
                ...
                }, this.dragging = new La(e.el), this.dragging.autoScroller.isEnabled = !1;
                let t = this.hitDragging = new Ga(this.dragging, Qi(e));
            ...
            constructor(e) {
                ...
                let i = this.hitDragging = new Ga(this.dragging, Qi(e));
            ...
            constructor(e) {
                this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = e => {
                    ...
                    let t = this.context.options.unselectCancel,
                        n = je(e.origEvent);
                    this.matchesCancel = !!Ie(n, t), this.matchesEvent = !!Ie(n, Ya.SELECTOR)
    ...
    class ol extends Xr {
        render() {
            let {
                ...
                seg: r
            } = e, i = Ai(r, n.eventTimeFormat || rl, t, !0, e.defaultDisplayEventEnd);
            return p(Ks, Object.assign({}, e, {
                elTag: "a",
    ...
    class ll extends Xr {
        constructor() {
            super(...arguments), this.compileSegs = nn(cl)
        }
        render() {
            let {
                props: e
            ...
            return p(po, {
                ...
                popoverContent: () => {
                    ...
                    return p(y, null, t.map(t => {
                        ...
                        }, il(t) ? p(ol, Object.assign({
                            seg: t,
                            isDragging: !1,
                            isSelected: r === e.eventSelection,
                            defaultDisplayEventEnd: !1
                        }, Di(t, e.todayRange))) : p(sl, Object.assign({
                            seg: t,
                            isDragging: !1,
                            isResizing: !1,
                            isDateSelecting: !1,
    ...
    class ml extends Jr {
        ...
        render() {
            let {
                ...
                options: r
            } = n, i = e.cells.length, s = tl(e.businessHourSegs, i), o = tl(e.bgEventSegs, i), a = tl(this.getHighlightSegs(), i), l = tl(this.getMirrorSegs(), i), {
                singleColPlacements: c,
                multiColPlacements: d,
                moreCnts: u,
                moreMarginTops: h
            } = fl(vi(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.eventInstanceHeights, t.maxContentHeight, e.cells), f = e.eventDrag && e.eventDrag.affectedInstances || e.eventResize && e.eventResize.affectedInstances || {};
            return p("tr", {
                ref: this.rootElRef,
                role: "row"
    ...
    class vl extends Jr {
        constructor() {
            super(...arguments), this.splitBusinessHourSegs = nn(el), this.splitBgEventSegs = nn(el), this.splitFgEventSegs = nn(el), this.splitDateSelectionSegs = nn(el), this.splitEventDrag = nn(nl), this.splitEventResize = nn(nl), this.rowRefs = new js
        }
        render() {
            let {
                props: e,
            ...
            return p(hs, {
                unit: "day"
            }, (t, d) => p(y, null, e.cells.map((t, u) => p(ml, {
        ...
        views: {
            dayGrid: {
                component: class extends wl {
                    constructor() {
                        super(...arguments), this.buildDayTableModel = nn(Cl), this.headerRef = {
                            current: null
                        }, this.tableRef = {
                            current: null
                        }
    ...
    function Tl(e) {
        ...
        return p(qr.Consumer, null, n => {
            ...
            let {
                ...
                options: i,
                viewApi: s
            } = n, o = null == i.slotLabelFormat ? _l : Array.isArray(i.slotLabelFormat) ? yn(i.slotLabelFormat[0]) : yn(i.slotLabelFormat), a = {
                level: 0,
                time: e.time,
    ...
    class Ol extends Jr {
        constructor() {
            super(...arguments), this.allDaySplitter = new xl, this.headerElRef = {
                current: null
            }, this.rootElRef = {
                current: null
            }, this.scrollerElRef = {
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            return h.push({
                ...
                chunks: [{
                    ...
                    }, e.tableColGroupNode, p("tbody", null, p(Ml, {
                        slatMetas: s
                    }))), p("div", {
    ...
    class Hl extends Xr {
        render() {
            ...
            return p("tbody", null, e.slatMetas.map((i, s) => {
                ...
                }, e.axis && p(Tl, Object.assign({}, i)), p(as, {
                    elTag: "td",
    ...
    class Bl extends Xr {
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight && t.onCoords(new Pl(new Br(this.rootElRef.current, (n = this.slatElRefs.currentMap, t.slatMetas.map(e => n[e.key])), !1, !0), this.props.dateProfile, e.options.slotDuration))
            }
            var n
        }
    }
    ...
    class Xl extends Xr {
        ...
        render() {
            ...
            return p(io, {
                ...
                className: "fc-timegrid-col-events"
            }, this.renderFgSegs(i, {}, Boolean(e.eventDrag), Boolean(e.eventResize), Boolean(r))), p("div", {
                className: "fc-timegrid-now-indicator-container"
        ...
        renderFgSegs(e, t, n, r, i) {
            ...
            return s.forPrint ? $l(e, s) : this.renderPositionedFgSegs(e, t, n, r, i)
        }
        renderPositionedFgSegs(e, t, n, r, i) {
            let {
                ...
                todayRange: h,
                nowDate: f
            } = this.props, g = n || r || i, m = ql(e, c, d, l), {
                segPlacements: v,
                hiddenGroups: b
            } = function (e, t, n, r) {
                let i = [],
            ...
            return p(y, null, this.renderHiddenGroups(b, e), v.map(e => {
                let {
                    seg: s,
                    rect: a
                } = e, l = s.eventRange.instance.instanceId, c = g || Boolean(!t[l] && a), d = Jl(a && a.span), m = !g && a ? this.computeSegHStyle(a) : {
                    left: 0,
                    right: 0
        ...
        renderFillSegs(e, t) {
            let {
                props: n,
                context: r
            } = this, i = ql(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                let s = e[i];
                return p("div", {
                    key: Ci(s.eventRange),
    ...
    class Kl extends Xr {
        constructor() {
            super(...arguments), this.splitFgEventSegs = nn(jl), this.splitBgEventSegs = nn(jl), this.splitBusinessHourSegs = nn(jl), this.splitNowIndicatorSegs = nn(jl), this.splitDateSelectionSegs = nn(jl), this.splitEventDrag = nn(zl), this.splitEventResize = nn(zl), this.rootElRef = {
                current: null
    ...
    class ec extends Jr {
        constructor() {
            super(...arguments), this.processSlotOptions = nn(tc), this.state = {
                slatCoords: null
            }, this.handleRootEl = e => {
    ...
    class rc extends Jr {
        constructor() {
            super(...arguments), this.buildDayRanges = nn(ic), this.slicer = new nc, this.timeColsRef = {
                current: null
            }
        }
        render() {
        ...
        let s = new Date(0),
            ...
            l = n || function (e) {
                ...
                for (t = sc.length - 1; t >= 0; t -= 1)
                    if (n = ht(sc[t]), r = yt(n, e), null !== r && r > 1) return n;
                return e
            }(r),
            c = [];
        for (; vt(o) < vt(t);) {
        ...
        views: {
            timeGrid: {
                component: class extends Ol {
                    constructor() {
                        super(...arguments), this.buildTimeColsModel = nn(ac), this.buildSlatMetas = nn(oc)
                    }
                    render() {
                        let {
                            options: e,
                        ...
                        }), h = !1 !== e.allDaySlot && (t => p(Sl, Object.assign({}, o.allDay, {
                            dateProfile: i,
                            dayTableModel: s,
                            nextDayThreshold: e.nextDayThreshold,
                            tableMinWidth: t.tableMinWidth,
                            ...
                            clientHeight: t.clientHeight,
                            forPrint: r.forPrint
                        }, this.getAllDayMaxEventProps()))), f = t => p(rc, Object.assign({}, o.timed, {
                            dayTableModel: s,
                            dateProfile: i,
                            axis: c,
                            slotDuration: e.slotDuration,
        ...
        views: {
            list: {
                component: class extends Jr {
                    constructor() {
                        super(...arguments), this.computeDateVars = nn(pc), this.eventStoreToSegs = nn(this._eventStoreToSegs), this.state = {
                            timeHeaderId: Ue(),
                            eventHeaderId: Ue(),
                            dateHeaderIdRoot: Ue()
                        }, this.setRootEl = e => {
                        ...
                        return p(hs, {
                            ...
                            for (let n = 0; n < a.length; n += 1) {
                                ...
                                if (d) {
                                    ...
                                    for (let t of d) c.push(p(hc, Object.assign({
    ...
    class yc extends Jr {
        constructor() {
            super(...arguments), this.buildDayTableModel = nn(Cl), this.slicer = new El, this.state = {
                labelId: Ue()
            }
        }
        render() {
    ...
    function Dc(e, t) {
        return e || (t[0].currentRange.start.getUTCFullYear() !== t[t.length - 1].currentRange.start.getUTCFullYear() ? Sc : Ac)
    }
    const wc = {
    ...
    var Cc = Po({
        ...
        views: {
            multiMonth: {
                component: class extends Jr {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = nn(Ec), this.buildMonthFormat = nn(Dc), this.scrollElRef = {
                            current: null
    ...
    return la.push(Ka, Rl, lc, vc, Cc), e.Calendar = class extends Ro {
        constructor(e, t = {}) {
            super(), this.isRendering = !1, this.isRendered = !1, this.currentClassNames = [], this.customContentRenderId = 0, this.handleAction = e => {
                ...
                function (e) {
                    _e(e.getRootNode())
                }(e), this.el = e, this.renderRunner = new Ps(this.handleRenderRequest), new ua({
                    optionOverrides: t,
                    calendarApi: this,
        ...
        constructor(e, t = {}) {
            ...
            n.touchScrollAllowed = !1, null != t.itemSelector && (n.pointer.selector = t.itemSelector), null != t.appendTo && (n.mirror.parentNode = t.appendTo), n.emitter.on("pointerdown", this.handlePointerDown), n.emitter.on("dragstart", this.handleDragStart), new $a(n, t.eventData)
        }
        destroy() {
            this.dragging.destroy()
        }
        ...
        constructor(e, t) {
            ...
            "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new $a(r, t.eventData)
        }
        destroy() {
            this.dragging.destroy()
        }
    ...
    }, e.globalLocales = To, e.globalPlugins = la, e.sliceEvents = function (e, t) {
        return ui(e.eventStore, e.eventUiBases, e.dateProfile.activeRange, t ? e.nextDayThreshold : null).fg
    }, e.version = "6.1.6", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});