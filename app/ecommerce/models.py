...
class Product(CommonInfo):
    ...
    # Assets for try-on
    image = models.ImageField(upload_to="products/images/", blank=True, null=True)  # 2D preview
...
class FashionTip(CommonInfo):
    ...
    cover_image = models.ImageField(upload_to="fashion_tips/images/", blank=True, null=True)
